...
<head>
  ...
  <link rel="stylesheet" href="/css/main.css?<?=filectime('css/animations.css')?>">
    ...
    <script type="module" src="node_modules/@vueuse">
        import Vue from "vue";
...
<body>
  <div class="main">
    <div id="calendar" class="calendar container-inner" >
        ...
        <div class="calendar-prev-container" v-on:click="prev">
            <h2>Prev.</h2>
        </div>
        <div class="calendar-next-container" v-on:click="next">
            <h2>Next.</h2>
        </div>
